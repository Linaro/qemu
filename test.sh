...
-device vfio-pci,host=0000:75:00.1,bus=pcie.port1,iommufd=iommufd0,x-pre-copy-dirty-page-tracking=off \
-device pcie-root-port,id=pcie.port2,bus=pcie.1,chassis=2,pref64-reserve=2M,io-reserve=1K \
-device vfio-pci,host=0000:76:00.1,bus=pcie.port2,iommufd=iommufd0,x-pre-copy-dirty-page-tracking=off \
